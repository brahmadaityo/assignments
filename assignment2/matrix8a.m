...
%Generate an M×N user defined matrix A with values between 0 to 100.
...
N = input(prompt);
fprintf("please enter the matrix manually\n");
for i = 1:M
    for j = 1:N
        fprintf("enter the value for A[%d][%d] th coloumn \n",i,j);
        A(i,j) = input('give the input');
    end
end
